...
export const webhooksTools: Tool[] = [
  ...
  defineTool({
    ...
    input: z.object({
    filter_deliveryState: z.union([z.array(z.enum(["SUCCEEDED", "FAILED", "PENDING"])), z.string()]).describe("filter by attribute 'deliveryState'").optional(),
    filter_createdDateGreaterThanOrEqualTo: z.union([z.array(z.string()), z.string()]).describe("filter by createdDateGreaterThanOrEqualTo").optional(),
    filter_createdDateLessThan: z.union([z.array(z.string()), z.string()]).describe("filter by createdDateLessThan").optional(),
    fields_webhookDeliveries: z.union([z.array(z.enum(["createdDate", "deliveryState", "errorMessage", "redelivery", "sentDate", "request", "response", "event"])), z.string()]).describe("the fields to include for returned resources of type webhookDeliveries").optional(),
    ...
    const res = await ascRequest({
      ...
      "filter[createdDateLessThan]": args["filter_createdDateLessThan"],
      "fields[webhookDeliveries]": args["fields_webhookDeliveries"],
      "fields[webhookEvents]": args["fields_webhookEvents"],
      "limit": args["limit"],
      "include": args["include"],
    },
      body: undefined,
