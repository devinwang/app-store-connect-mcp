...
/**
 * Define a tool from a zod schema + typed handler. The wrapper validates
 * arguments at runtime so bad calls produce a clean error rather than
 * a TypeError deep inside the HTTP client.
 */
