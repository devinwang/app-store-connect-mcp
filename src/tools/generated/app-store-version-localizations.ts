...
export const appStoreVersionLocalizationsTools: Tool[] = [
  ...
  defineTool({
    ...
    "filter[appCustomProductPageLocalization]": z.union([z.array(z.string()), z.string()]).describe("filter by id(s) of related 'appCustomProductPageLocalization'").optional(),
    ...
    const res = await ascRequest({
      ...
      "filter[appCustomProductPageLocalization]": args["filter[appCustomProductPageLocalization]"],
