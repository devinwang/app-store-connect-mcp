...
// Tag: AppStoreVersionExperimentTreatmentLocalizations
// Tool count: 7
...
export const appStoreVersionExperimentTreatmentLocalizationsTools: Tool[] = [
  defineTool({
    name: "app_store_version_experiment_treatment_localizations_create_instance",
    description: "POST /v1/appStoreVersionExperimentTreatmentLocalizations (POST /v1/appStoreVersionExperimentTreatmentLocalizations) Body shape: see OpenAPI components.schemas.AppStoreVersionExperimentTreatmentLocalizationCreateRequest for the full JSON:API envelope.",
    input: z.object({
    body: z.record(z.unknown()).describe("JSON body. Shape: components.schemas.AppStoreVersionExperimentTreatmentLocalizationCreateRequest."),
  }).strict(),
  ...
  defineTool({
    name: "app_store_version_experiment_treatment_localizations_get_instance",
    description: "GET /v1/appStoreVersionExperimentTreatmentLocalizations/{id} (GET /v1/appStoreVersionExperimentTreatmentLocalizations/{id})",
    input: z.object({
  ...
  defineTool({
    name: "app_store_version_experiment_treatment_localizations_app_preview_sets_get_to_many_related",
    description: "GET /v1/appStoreVersionExperimentTreatmentLocalizations/{id}/appPreviewSets (GET /v1/appStoreVersionExperimentTreatmentLocalizations/{id}/appPreviewSets)",
    input: z.object({
  ...
  defineTool({
    name: "app_store_version_experiment_treatment_localizations_app_screenshot_sets_get_to_many_related",
    description: "GET /v1/appStoreVersionExperimentTreatmentLocalizations/{id}/appScreenshotSets (GET /v1/appStoreVersionExperimentTreatmentLocalizations/{id}/appScreenshotSets)",
    input: z.object({
